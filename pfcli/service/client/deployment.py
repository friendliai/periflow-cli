...
class DeploymentClientService(ClientService):
    def get_deployment(self, deployment_id: T) -> dict:
    ...
    def delete_deployment(self, deployment_id: T) -> None:
        safe_request(self.delete, err_prefix="Failed to delete deployment.")(pk=deployment_id)
