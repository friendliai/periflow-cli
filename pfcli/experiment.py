...
def create(
    name: str = typer.Option(
        ..., "--name", "-n", help="The name of experiment to create."
    )
):
    """Create a new experiment."""
    client: ProjectExperimentClientService = build_client(
...
@app.command()
def view(
    name: str = typer.Argument(..., help="The name of experiment to view details."),
    ...
    project_client: ProjectExperimentClientService = build_client(
        ServiceType.PROJECT_EXPERIMENT
    )
...
@app.command()
def edit(
    name: str = typer.Argument(..., help="The name of experiment to update."),
    new_name: str = typer.Option(..., "--name", "-n", help="The new new of experiment"),
):
...
@app.command()
def delete(
    name: str = typer.Argument(..., help="The name of experiment to delete."),
    ...
    if not force:
        ...
        if not do_delete:
            raise typer.Abort()
        really_do_delete = typer.confirm(
            "STOP!!! Are you really sure to delete? This is the last confirmation."
        )
