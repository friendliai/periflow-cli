...
from pfcli.service.cloud import (
    AWSCloudStorageHelper,
    AzureCloudStorageHelper,
    build_storage_helper,
)
...
def test_aws_list_storage_files(
    aws_storage_helper: AWSCloudStorageHelper, s3_client_mock
):
    # Success
    file_data = [
        {
...
def test_azure_list_storage_files(
    azure_storage_helper: AzureCloudStorageHelper, blob_client_mock, container_client
):
    file_data = [
        {
            "name": "dir/",
